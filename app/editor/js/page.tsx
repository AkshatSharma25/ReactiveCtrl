...
const EditorPage = () => {
    ...
    const handleSubmitCode = async () => {
        ...
        const response = await axios.post(`/api/submit/js`, { code: code,uid:user.uid })
        ...
        <div className={`flex flex-col  h-[100vh]`}>
            <div className='flex items-center justify-center'>
                <div className={`absolute top-0 left-[25vw] ${outputWindowVisibility ? "" : "hidden"}`}>
                    ...
                    <OutputWindow visible={outputWindowVisibility} output={finalOutput} show={showOutput} language={"JAVASCRIPT"} />
                </div>

                <Navbar language={"JavaScript"} tab={"Editor"}/>
